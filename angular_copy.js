...
// angularModule = angular.module = function (modulenae, require, config);
//angularModule('moduelbame'); - call it
        ...
        if (isString(module)) {
          ...
          for(invokeQueue = moduleFn._invokeQueue, i = 0, ii = invokeQueue.length; i < ii; i++) {
            var invokeArgs = invokeQueue[i],
                provider = providerInjector.get(invokeArgs[0]); // providerCache->$provide
...
//        console.log(' if nserviceName ' + serviceName);
...
//          console.log(' else serviceName ' + serviceName + ' -- ' + factory(serviceName));
          return cache[serviceName] = factory(serviceName);
        } catch (err) {
//             console.log(' catch serviceName ' + serviceName + ' -- ' + factory(serviceName));
          if (cache[serviceName] === INSTANTIATING) {
            delete cache[serviceName];
          }
          throw err;
        } finally {
//             console.log(' finally serviceName ' + serviceName + ' -- ' + factory(serviceName));
          path.shift();
        }
      }
    }
